...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Tự động chuyển đến trang problems sau khi đăng ký thành công
      navigate('/problems');
    } catch (error) {
    ...
    <div className="max-w-md mx-auto mt-10">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700 transition-all duration-300">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-gray-700 dark:text-slate-300 mb-2 font-medium">Username</label>
            <input
              type="text"
              name="username"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 dark:text-slate-300 mb-2 font-medium">Email</label>
            <input
              type="email"
              name="email"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 dark:text-slate-300 mb-2 font-medium">Họ tên <span className="text-gray-400 dark:text-slate-500 font-normal">(tùy chọn)</span></label>
            <input
              type="text"
              name="fullName"
          ...
          <div className="mb-6">
            <label className="block text-gray-700 dark:text-slate-300 mb-2 font-medium">Xác nhận mật khẩu</label>
            <input
              type="password"
